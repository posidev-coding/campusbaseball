<flux:tab.group class="flex flex-col items-center pt-4">
    <div class="shrink">
        <flux:tabs wire:model="tab" variant="pills" size="sm">
            <flux:tab name="scoring">Scoring</flux:tab>
            <flux:tab name="pbp">Play-By-Play</flux:tab>
        </flux:tabs>
    </div>


    <flux:tab.panel name="pbp" class="flex justify-center pt-2 md:pt-4">
        <div class="border dark:border-muted rounded-lg lg:mx-4 max-w-4xl">
    ...
    <flux:tab.panel name="scoring" class="flex justify-center pt-2 md:pt-4">
